        ...
        <div class="wrapper">
          <section class="post">
            ...
            <div class="form" >
              ...
              <hr>
              <textarea v-model="post_desc" placeholder="What's on your mind, BlogLite " spellcheck="false" required></textarea>
              ...
              <button v-on:click="addPost">Update Post</button>
            </div>
          </section>
...
export default {
   ...
   methods:{
     ...
     addPost(){
       fetch(`${this.link}/api/${this.user_id}/${this.post_id}`, {
         method: "PUT",
         headers: {
